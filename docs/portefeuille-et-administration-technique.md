...
description: Orientation page for the former portfolio and technical administration URL, now split into Portfolio, AI providers and platform integrations, and seats management and app updates.
---

[Home](./index.md) · [Portfolio](./portfolio.md) · [AI providers and platform integrations](./ai-providers-platform-integrations.md) · [Seats management and app updates](./seats-management-app-updates.md)
...
| Manage subscription seats, assigned users, app updates, image inventory and rollback on existing Azure Container Apps | [Seats management and app updates](./seats-management-app-updates.md) |

## Product rule about Marketplace plans

All Marketplace plans expose the same product features. Only the number of purchased licenses/seats differs.

If a user is blocked, check seats, roles, project access, bindings, policy, configuration or health. Do not interpret the plan as a feature tier.
...
3. Use [Seats management and app updates](./seats-management-app-updates.md) if the question is about access allocation, subscription seats or updating an existing installation.
