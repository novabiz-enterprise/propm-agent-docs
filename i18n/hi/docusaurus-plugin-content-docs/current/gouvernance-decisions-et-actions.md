...
यह पृष्ठ आपको स्पष्ट रूप से समझने में मदद करता है:
...
![प्रोजेक्ट शासन नीतियाँ](/img/screenshots/localized/hi/14-governance-policies.jpg)
...
![Actions & approvals पैनल](/img/screenshots/localized/hi/17-actions-approvals.jpg)
...
- `blocked by entitlement` = plan से न जुड़ा legacy block wording; configuration, binding, policy, permission, approval या health जाँचें ;
...
| कनेक्टर मौजूद है लेकिन उपयोग योग्य नहीं | binding, health, configuration, policy या permission पर्याप्त नहीं है | प्लेटफ़ॉर्म, प्रोजेक्ट और नीति की पूरी श्रृंखला जाँचें |
...
- connector, binding, policy, permission, approval या health state flow को block करता है।
...
4. अंत में **configuration**, **binding**, **permission** और connector health जाँचें।
