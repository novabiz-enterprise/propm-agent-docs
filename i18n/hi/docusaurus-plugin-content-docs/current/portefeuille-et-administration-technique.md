...
ProPM Agent में **Portfolio** मुख्यतः PMO-शैली की बहु-परियोजना समीक्षा सतह है। यह एक ही संकेतक मॉडल के आधार पर कई परियोजनाओं की तुलना करने में मदद करती है, उससे पहले कि आप किसी एक परियोजना का विस्तृत दृश्य खोलें।
...
## प्रारंभिक डिफ़ॉल्ट सेटिंग्स

यह पृष्ठ बिल्कुल खाली कॉन्फ़िगरेशन से शुरू नहीं होता। डिफ़ॉल्ट मान सामान्यतः ये हैं:
...
उत्पाद में दिखाई देने वाले संकेतक मुख्यतः हैं:
...
ProPM Agent में, एक परियोजना आउट्लायर के रूप में उभरती है जब:
...
### क्या central रहता है और क्या project settings में जाता है

| जिम्मेदारी | Platform Administration में रखा जाता है | Project integrations में दिखाई देता है |
| --- | --- | --- |
...
| Operational binding | enterprise connector/provider को enable या disable करना और technical health validate करना | project availability के लिए **Bind to project**, **Validate binding** और **Disable** |
| User guidance | admin audit, validation history और tenant-scoped configuration | **Open Platform Administration** और **Open Knowledge imports** जैसे contextual links |
