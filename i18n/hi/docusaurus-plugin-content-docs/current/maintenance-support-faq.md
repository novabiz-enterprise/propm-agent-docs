...
- environment में वही sample data नहीं है जो किसी दूसरी screenshot, documentation उदाहरण या test में दिखती है।
...
live environments अलग हो सकते हैं। कुछ projects वही preloaded documents, preloaded reports या search examples नहीं दिखाते जो documentation या दूसरे tests में दिखते हैं।
