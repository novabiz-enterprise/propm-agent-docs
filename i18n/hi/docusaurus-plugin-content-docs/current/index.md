...
यह दस्तावेज़ केवल उन क्षमताओं का वर्णन करता है जिन्हें ProPM Agent के इंटरफ़ेस, कोड, डिप्लॉयमेंट कॉन्फ़िगरेशन और स्वचालित परीक्षणों में प्रत्यक्ष रूप से देखा गया है।
...
निम्न तत्व इंटरफ़ेस, seeded data, या tests में स्पष्ट रूप से दिखाई देते हैं:
...
एप्लिकेशन के स्क्रीनशॉट देखे गए परिवेश से लिए गए हैं। जब उपलब्ध स्क्रीनशॉट अधिकतर loading state या अधूरा demo data दिखाते थे, तब इस हिंदी संस्करण में व्याख्यात्मक diagrams भी शामिल किए गए हैं ताकि अंतिम प्रकाशन से पहले भी पाठ उपयोगी बना रहे।

डेमो सामग्री परिवेश के अनुसार बदल सकती है। कुछ परियोजनाएँ हर बार वही seeded documents, seeded reports या उदाहरण नहीं दिखातीं जो दस्तावेज़ में दिखाई देते हैं।
...
| --- | --- |
| तकनीकी समर्थन | deployment URL, संबंधित परियोजना, देखी गई स्थिति, अनुमानित समय, और यदि दिखाई दे तो `Trace ID` |
