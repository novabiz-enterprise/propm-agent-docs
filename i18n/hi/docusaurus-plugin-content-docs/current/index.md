...
| कोई कार्रवाई दिखाई दे रही है, पर अवरुद्ध है | [गवर्नेंस, निर्णय और क्रियाएँ](./gouvernance-decisions-et-actions.md) | [कनेक्टर्स और एकीकरण](./connecteurs-jira-et-sharepoint), फिर connector, binding, configuration, policy या health के लिए [AI providers और platform integrations](./ai-providers-platform-integrations.md), या remaining license availability के लिए [Tenant plan, licensed users और app updates](./seats-management-app-updates.md) |
| AI प्रदाता काम करता नहीं दिख रहा | [AI providers और platform integrations](./ai-providers-platform-integrations.md) | [रखरखाव, समर्थन और FAQ](./maintenance-support-faq.md) और [रिपोर्ट, AI Log और ट्रेसबिलिटी](./rapports-journal-ia-et-tracabilite.md), ताकि वास्तविक प्रदाता की पुष्टि हो सके |
...
| परियोजनाओं की तुलना करना, एकीकरण, AI और licenses प्रबंधित करना | [पोर्टफोलियो](./portfolio.md) · [AI providers और platform integrations](./ai-providers-platform-integrations.md) · [Tenant plan, licensed users और app updates](./seats-management-app-updates.md) |
...
| तकनीकी प्रशासक | [Azure Marketplace डिप्लॉयमेंट](./deploiement-azure-marketplace.md) → [शुरुआत](./demarrage.md) → [AI providers और platform integrations](./ai-providers-platform-integrations.md) → [Tenant plan, licensed users और app updates](./seats-management-app-updates.md) → [रखरखाव, समर्थन और FAQ](./maintenance-support-faq.md) |
...
| व्यावसायिक या सदस्यता संबंधी प्रश्न | account context, current plan, ordered seats, supplemental licenses, used seats और license need |
