...
Cette documentation vous aide à utiliser ProPM Agent au quotidien : navigation, projets, connaissance, agents, gouvernance, rapports, administration et déploiement.
...
Les éléments suivants sont visibles dans l’interface ou les exemples préchargés :
...
Les captures et schémas servent de repères visuels. Ils illustrent les écrans principaux et peuvent varier légèrement selon les données, les droits et la configuration de votre environnement.

Les exemples préchargés peuvent aussi varier selon l’environnement : certains projets n’exposent pas toujours les mêmes documents, rapports ou exemples visibles dans les captures.
